	...
	<div>
		...
		<section className="content">
			...
			<div className="row">
				...
				{/* small box */}
				<SmallBox id="new-orders" style="info" value={150} description="New Orders" icon="ion-bag" />
				</div>
				{/* ./col */}
				<div className="col-lg-3 col-6">
				{/* small box */}
				<SmallBox id="bounce-rate" style="success" value={53} description="Bounce Rate" icon="ion-stats-bars" percent={true} />
				</div>
				{/* ./col */}
				<div className="col-lg-3 col-6">
				{/* small box */}
				<SmallBox id="user-registrations" value={44} description="User Registrations" icon="ion-person-add" style="warning" />
				</div>
				{/* ./col */}
				<div className="col-lg-3 col-6">
				{/* small box */}
				<SmallBox id="unique-visitors" value={65} description="Unique Visitors" icon="ion-pie-graph" style="danger" />
				</div>
				{/* ./col */}
			</div>
			{/* /.row */}
